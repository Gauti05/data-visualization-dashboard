...
function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const loginResponse = await axios.post('http://localhost:8000/login', { email, password });
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center p-6 transition-colors">
      <div className="max-w-md w-full bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
        <h2 className="text-3xl mb-6 font-bold text-center text-gray-900 dark:text-white">Sign Up</h2>
